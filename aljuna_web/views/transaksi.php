  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <i class="icon-file-alt"></i> Transaksi</li>
      </ol>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped" id="datatables">
          ...
          <?php
          $no = 1;
          $tampil = $transaksi->tampil(null,@$_GET['status']);
          while ($data = $tampil->fetch_object()) {
            ...
            <tr>
              ...
              <td><?php 
                        ...
                        ?></td>
              <td><a class="btn btn-info" href="?page=detail_transaksi&id_transaksi=<?php echo $data->id_transaksi; ?>">Detail</a></td>
            </tr>
            <?php 
          } ?>
          </tbody>
